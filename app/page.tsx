  ...
  return (
    <main>
      ...
      <footer className="footer shell">
        ...
        <div><a href="#pricing">Тарифы</a><a href="#faq">Вопросы</a><a href={`${APP_ORIGIN}/legal/offer`}>Условия оплаты</a><a href={`${APP_ORIGIN}/legal/privacy`}>Конфиденциальность</a><a href={`${APP_ORIGIN}/legal/refunds`}>Возвраты</a><a href="mailto:vizhufasad0058@bk.ru">vizhufasad0058@bk.ru</a></div>
